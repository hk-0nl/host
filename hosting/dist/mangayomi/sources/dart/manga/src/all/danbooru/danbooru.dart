...
class Danbooru extends MProvider {
  ...
  Future<MManga> getDetail(String url) async {
    ...
    if (isVideo) {
      ...
      if (chapters.isEmpty) {
        chapters.add(MChapter(name: "Open Post", url: "${_base()}/posts/$id"));
      }
    ...
    if (body.startsWith("{")) {
      ...
      try {
        ...
        if (obj is Map && obj["success"] == false) {
          ...
          throw Exception("Danbooru: $msg (composed query: '$tagQuery')");
        }
  ...
  List<dynamic> getSourcePreferences() {
    return [
      EditTextPreference(
        key:         "domain_url",
        title:       "Base URL",
        summary:     "e.g. https://danbooru.donmai.us — change to use Safebooru or other clones",
      ...
      EditTextPreference(
        key:         "login",
        title:       "Login",
        summary:     "Danbooru username. Required to lift the 2-tag limit to 6 tags, "
