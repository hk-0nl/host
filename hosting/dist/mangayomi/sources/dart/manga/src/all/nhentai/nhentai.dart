...
class NHentai extends MProvider {
  ...
  Future<String> _fetchJson(Uri uri) async {
    ...
    if (body.startsWith("<")) {
      throw Exception(
        "Cloudflare blocked the request. Enable Cloudflare Bypass in settings.",
      );
    }
    return body;
  }
  ...
  List<dynamic> getSourcePreferences() {
    return [
      CheckBoxPreference(
        ...
        summary:
            "Enable if you encounter 403 or 503 errors. Slows down loading but bypasses Cloudflare checks.",
        value: false,
      ),
    ];
  }
