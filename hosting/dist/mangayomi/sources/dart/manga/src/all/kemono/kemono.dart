...
class Kemono extends MProvider {
  ...
  Future<List<dynamic>> fetchPosts({
    ...
    fail(
      "posts feed was not a JSON array (type: ${decoded.runtimeType})",
      url: uri.toString(),
    );
  }
  ...
  List<dynamic> getSourcePreferences() {
    return [
      EditTextPreference(
        ...
        title: "API Base URL",
        summary:
            "Default: https://kemono.su/api/v1 (kemono.cr is the main site, but it has a Cloudflare block wall for the API)",
