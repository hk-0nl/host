  ...
  List<dynamic> getSourcePreferences() {
    return [
      EditTextPreference(
        ...
        title: "Base URL",
        summary:
            "e.g. https://gelbooru.com — can point at other Gelbooru-compatible boards",
      ...
      EditTextPreference(
        ...
        title: "User ID",
        summary:
            "Gelbooru User ID — required for explicit content and favorites. "
      ...
      EditTextPreference(
        ...
        title: "AI Blocklist",
        summary:
            "Comma-separated tags to exclude from all results. Prepended as -tag exclusions.",
