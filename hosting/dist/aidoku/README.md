...
- Gelbooru v13: `https://raw.githubusercontent.com/hk-0nl/host/main/hosting/dist/aidoku/sources/multi.gelbooru-v13.aix`
...
Gelbooru v13 adds separate Similar Posts and Pool Relationships sections to post details and the Post information companion chapter. Similar-post links route to the related Gelbooru post when opened from Aidoku's detail description; pool links remain provider pool pages and cannot be misparsed as post IDs. The release retains signed-out search/filters, Latest and all-time Overall/Static/Animated discovery, Top Tags Home links, categorized metadata, static/GIF image pages, WebM/MP4 web fallback, provider-authored translations, and public comments. Website authentication, Favorites, Saved Searches, comment mutations, and parent/child/sibling family relationships remain foundations or planned work rather than claimed account functionality.
