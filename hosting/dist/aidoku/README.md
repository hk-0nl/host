...
- nhentai v23: `https://raw.githubusercontent.com/hk-0nl/host/main/hosting/dist/aidoku/sources/multi.nhentai-v23.aix`
...
nhentai v23 provides recent/popular listings, Home sections, qualified creator/tag filters, account-favorites search, local saved searches, language/title/blocklist settings, rich gallery metadata, image pages, and deep links. Public mode uses a safe nine-request-per-minute budget; a validated API key raises the shared budget to fifteen requests per minute. Bounded 60-second response caches reuse repeated Home/listing/search and numeric lookup/detail/chapter/page work.
