...
- Gelbooru v1: `https://raw.githubusercontent.com/hk-0nl/host/main/hosting/dist/aidoku/sources/multi.gelbooru-v1.aix`
...
Gelbooru v1 provides signed-out search and filters, Latest/Popular/Popular Animated listings, three Home sections, rich post metadata, an optional `Display all site content` setting, static/GIF image pages, and explicit WebM/MP4 web fallback because Aidoku has no native video page type. Account credentials remain optional and are only used for API-backed access and future favorites work.
