...
- Gelbooru v10: `https://raw.githubusercontent.com/hk-0nl/host/main/hosting/dist/aidoku/sources/multi.gelbooru-v10.aix`
...
Gelbooru v10 provides signed-out search/filters, Latest and all-time Overall/Static/Animated discovery, Top Tags Home links, categorized metadata, static/GIF image pages, and explicit WebM/MP4 web fallback because Aidoku has no native video page type. Display All OFF now adds Gelbooru's documented loli/shota exclusions to both HTML and DAPI queries, while ON removes them; the website preference cookie remains a secondary compatibility path. Details include a second Post information text chapter after the primary media chapter. Website authentication, Favorites, Saved Searches, comments, translated notes, and relationship groups remain foundations or planned work rather than claimed account functionality.
