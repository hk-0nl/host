...
- nhentai v18: `https://raw.githubusercontent.com/hk-0nl/host/main/hosting/dist/aidoku/sources/multi.nhentai-v18.aix`
...
nhentai v18 provides recent/popular listings, Home sections, creator/tag/sort filters, language/title/blocklist settings, rich gallery metadata, image pages, and deep links. It stays below the provider's 10-request-per-minute API limit, loads Home sections sequentially, and honors the provider's 60-second `Retry-After` once instead of returning blank search/listing results.
